...
while (indexDiff === 0) {
	...
	let player1Array = ['paper', 'rock', 'scissors'];
	let player2Array = ['paper', 'rock', 'scissors'];
	let player1Index = player1Array.indexOf(player1);
	let player2Index = player2Array.indexOf(player2);
